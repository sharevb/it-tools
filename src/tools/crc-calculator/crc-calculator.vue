...
function getCRCs(content: Uint8Array | string) {
  return {
    crc1: crc.crc1(content as any).toString(16),
    crc8: crc.crc8(content as any).toString(16),
    crc81wire: crc.crc81wire(content as any).toString(16),
    crc8dvbs2: crc.crc8dvbs2(content as any).toString(16),
    crc16: crc.crc16(content as any).toString(16),
    crc16ccitt: crc.crc16ccitt(content as any).toString(16),
    crc16modbus: crc.crc16modbus(content as any).toString(16),
    crc16kermit: crc.crc16kermit(content as any).toString(16),
    crc16xmodem: crc.crc16xmodem(content as any).toString(16),
    crc24: crc.crc24(content as any).toString(16),
    crc32: crc.crc32(content as any).toString(16),
    crc32mpeg: crc.crc32mpeg2(content as any).toString(16),
    crcjam: crc.crcjam(content as any).toString(16),
  };
}
