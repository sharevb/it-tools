...
const rawIpAddress = useQueryParamOrStorage({
  name: 'ip',
  storageName: 'ipv4-converter:ip',
...
const { attrs: validationAttrs } = useValidation({
  ...
  rules: [
    {
      message: t('tools.ipv4-address-converter.texts.message-invalid-ipv4-address'),
...
<template>
  <div>
    <c-input-text
      ...
      :label="t('tools.ipv4-address-converter.texts.label-the-ipv4-address')"
      :placeholder="t('tools.ipv4-address-converter.texts.placeholder-the-ipv4-address')"
    />
