declare module 'is-ip' {
  ...
  ```
   */
  export function isIP(string: string): boolean; // eslint-disable-line ts/naming-convention
  ...
  ```
   */
  export function isIPv6(string: string): boolean; // eslint-disable-line ts/naming-convention
  ...
  ```
   */
  export function isIPv4(string: string): boolean; // eslint-disable-line ts/naming-convention
