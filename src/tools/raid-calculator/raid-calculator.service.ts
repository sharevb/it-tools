...
const raidCalculations: { [key: string]: RaidType } = {
  raid_0: {
    about: t(
      'tools.raid-calculator.service.text.raid-0-splits-data-evenly-across-2-or-more-disks-without-redunancy-or-fault-tolerance-creating-one-large-storage-space',
    ),
  ...
  raid_1: {
    about: t(
      'tools.raid-calculator.service.text.raid-1-consists-of-an-exact-copy-of-the-data-mirror-across-two-or-more-disks-the-array-will-operate-as-long-as-at-least-one-drive-is-operational',
    ),
  ...
  raid_5: {
    about: t(
      'tools.raid-calculator.service.text.raid-5-uses-block-level-striping-with-parity-this-allows-for-fault-tolerance-with-a-storage-reduction-equal-to-one-drive-for-the-parity-information',
    ),
  ...
  raid_6: {
    about: t(
      'tools.raid-calculator.service.text.raid-6-is-similiar-to-raid-5-but-with-an-additional-parity-block-this-allows-for-an-additional-disk-failure-at-the-cost-of-storage-reduction-equal-to-two-drives',
    ),
  ...
  raid_7: {
    about: t(
      'tools.raid-calculator.service.text.raid-7-raid-tp-non-standard-is-similiar-to-raid-5-and-raid-6-but-with-a-third-parity-block-this-allows-for-a-third-disk-failure-at-the-cost-of-storage-reduction-equal-to-three-drives',
    ),
  ...
  raid_10: {
    about: t(
      'tools.raid-calculator.service.text.raid-10-is-a-stripe-of-mirrors-raid-1-raid-0-each-set-of-drives-is-mirrored-and-striped-together-so-that-each-drive-in-the-set-is-fault-tolerant-within-the-group',
    ),
  ...
  raid_50: {
    about: t(
      'tools.raid-calculator.service.text.raid-50-stripes-multiple-raid-5-arrays-together-raid-5-raid-0-each-raid-5-set-can-sustain-a-single-drive-failure',
    ),
    requirements: t(
      'tools.raid-calculator.service.text.raid-50-requires-at-least-6-disks-with-3-minimum-per-stripe-stripes-must-contain-an-equal-number-of-disks',
    ),
  ...
  raid_60: {
    about: t(
      'tools.raid-calculator.service.text.raid-60-stripes-multiple-raid-6-arrays-together-raid-6-raid-0-each-raid-6-set-can-sustain-two-drive-failures',
    ),
    requirements: t(
      'tools.raid-calculator.service.text.raid-60-requires-at-least-8-disks-with-4-minimum-per-stripe-stripes-must-contain-an-equal-number-of-disks',
    ),
    validate(num: number, size: number, stripeSize: number) {
  ...
  raid_70: {
    about: t(
      'tools.raid-calculator.service.text.raid-70-stripes-multiple-raid-7-arrays-together-raid-7-raid-0-each-raid-7-set-can-sustain-three-drive-failures',
    ),
    requirements: t(
      'tools.raid-calculator.service.text.raid-70-requires-at-least-10-disks-with-5-minimum-per-stripe-stripes-must-contain-an-equal-number-of-disks',
    ),
    validate(num: number, size: number, stripeSize: number) {
