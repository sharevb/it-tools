...
<template>
  <div>
    <c-alert type="warning" mb-2>
      {{ t('tools.math-ocr.texts.tag-nb-processing-is-done-in-your-browser-so-be-patient-processing-can-take-a-while')
      }}<br />{{ t('tools.math-ocr.texts.tag-this-tool-required-internet-connection-to-access-models') }}
    </c-alert>
    ...
    <div>
      ...
      <div style="text-align: center">
        <katex-element
          v-if="!ocrInProgress"
          :expression="latexResult?.replace(/\$\$$|^\$\$/g, '')"
