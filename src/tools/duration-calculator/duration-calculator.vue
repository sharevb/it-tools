...
<template>
  <div>
    <c-input-text
      ...
      :placeholder="
        t('tools.duration-calculator.texts.placeholder-please-enter-duration-one-per-line-with-optional-sign')
      "
      mb-2
    />
    <n-p>{{
      t('tools.duration-calculator.texts.tag-supports-comment-line-hh-mm-ss-fff-3d-1h-3s-p4dt12h20m20-3s')
    }}</n-p>
    ...
    <c-card :title="t('tools.duration-calculator.texts.title-total')">
      ...
      <input-copyable
        :label="t('tools.duration-calculator.texts.label-prettified-full')"
        :value="result.total.prettifiedVerbose"
      />
      <input-copyable
        :label="t('tools.duration-calculator.texts.label-prettified-colon')"
        :value="result.total.prettifiedColonNotation"
      />
      <input-copyable
        :label="t('tools.duration-calculator.texts.label-prettified-days')"
        :value="result.total.prettifiedDaysColon"
      />
      <input-copyable
        :label="t('tools.duration-calculator.texts.label-prettified-hours')"
        :value="result.total.prettifiedHoursColon"
      />
      <input-copyable
        :label="t('tools.duration-calculator.texts.label-prettified-iso8601')"
        :value="result.total.iso8601Duration"
      />
      <input-copyable
        :label="t('tools.duration-calculator.texts.label-milliseconds')"
        :value="result.total.milliseconds"
      />
