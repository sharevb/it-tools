...
const xhtmlOutput = useQueryParamOrStorage({
  name: 'xhtml',
  storageName: 'html-wysiwyg-editor--xhtml',
  defaultValue: false,
});
const minifyOutput = useQueryParamOrStorage({
  name: 'minify',
  storageName: 'html-wysiwyg-editor--min',
  defaultValue: false,
});
