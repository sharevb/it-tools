...
const typeOptions = [
  { label: t('tools.meta-tag-generator.__i18n_ally_root__.qr-contact-info-generator.texts.label-website'), value: 'website' },
...
export const website: OGSchemaType = {
  ...
  elements: [
    ...
    { type: 'input', label: t('tools.meta-tag-generator.__i18n_ally_root__.xslt-tester.texts.tag-title'), placeholder: t('tools.meta-tag-generator.website.text.enter-the-title-of-your-website'), key: 'title' },
    {
      type: 'input',
      label: t('tools.meta-tag-generator.__i18n_ally_root__.ical-generator.texts.label-description'),
