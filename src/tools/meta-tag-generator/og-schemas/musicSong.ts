  ...
  elements: [
    {
      ...
      placeholder: t('tools.meta-tag-generator.musicSong.text.the-duration-of-the-song'),
      key: 'music:duration',
    },
    {
      type: 'input',
      label: t('tools.meta-tag-generator.musicSong.text.album'),
      placeholder: t('tools.meta-tag-generator.musicSong.text.the-album-this-song-is-from'),
      key: 'music:album',
    },
    {
      type: 'input',
    ...
    },
    {
      ...
      placeholder: t('tools.meta-tag-generator.musicSong.text.which-track-this-song-is'),
