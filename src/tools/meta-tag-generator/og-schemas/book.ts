  ...
  elements: [
    {
      ...
      key: 'book:author',
      placeholder: t('tools.meta-tag-generator.book.text.who-wrote-this-book'),
    },
    {
      type: 'input',
      label: t('tools.meta-tag-generator.texts.isbn'),
      key: 'book:isbn',
      placeholder: t('tools.meta-tag-generator.book.text.the-international-standard-book-number'),
    },
    {
      type: 'input',
    ...
    },
    {
      ...
      key: 'book:tag',
      placeholder: t('tools.meta-tag-generator.book.text.tag-words-associated-with-this-book'),
    },
  ],
};
