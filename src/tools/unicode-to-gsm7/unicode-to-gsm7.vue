...
<template>
  ...
  <n-card v-if="smsInfo" :title="t('tools.unicode-to-gsm7.texts.title-sms-info')">
    <input-copyable
      :label="t('tools.unicode-to-gsm7.texts.label-encoding')"
      label-position="left"
      :value="smsInfo.encodingName"
      mb-1
    />
    <input-copyable
      :label="t('tools.unicode-to-gsm7.texts.label-message-size')"
      label-position="left"
      :value="smsInfo.messageSize"
      mb-1
    />
    <input-copyable
      :label="t('tools.unicode-to-gsm7.texts.label-total-size')"
      label-position="left"
      :value="smsInfo.totalSize"
      mb-1
    />
    <input-copyable
      :label="t('tools.unicode-to-gsm7.texts.label-segments-count')"
      label-position="left"
      :value="smsInfo.segmentsCount"
      mb-1
    />
    <input-copyable
      :label="t('tools.unicode-to-gsm7.texts.label-non-gsm-7-characters')"
      label-position="left"
      :value="[...new Set(smsInfo.getNonGsmCharacters())].join(',')"
    />
  </n-card>
</template>
