...
<template>
  <div flex flex-col items-center gap-4>
    <c-input-text
      v-model:value="word"
      :placeholder="t('tools.numeronym-generator.texts.placeholder-enter-a-word-e-g-internationalization')"
      size="large"
      clearable
      test-id="word-input"
    />
    ...
    <input-copyable
      ...
      size="large"
      readonly
      :placeholder="t('tools.numeronym-generator.texts.placeholder-your-numeronym-will-be-here-e-g-i18n')"
      test-id="numeronym"
    />
  </div>
</template>
