    ...
    <div grid grid-cols-1 gap-12>
      <div>
        <c-select
          ...
          mb-4
          :label="t('tools.wifi-qr-code-generator.texts.label-encryption-method')"
          default-value="WPA"
          label-position="left"
          label-width="130px"
          label-align="right"
        ...
        <div class="mb-6 flex flex-row items-center gap-2">
          <c-input-text
            ...
            label-width="130px"
            label-align="right"
            :label="t('tools.wifi-qr-code-generator.texts.label-ssid')"
            rows="1"
            autosize
            :placeholder="t('tools.wifi-qr-code-generator.texts.placeholder-your-wifi-ssid')"
            mb-6
          />
        ...
        <c-input-text
          ...
          label-width="130px"
          label-align="right"
          :label="t('tools.wifi-qr-code-generator.texts.label-password')"
          rows="1"
          autosize
          type="password"
          :placeholder="t('tools.wifi-qr-code-generator.texts.placeholder-your-wifi-password')"
          mb-6
        />
        <c-select
          v-if="encryption === 'WPA2-EAP'"
          v-model:value="eapMethod"
          :label="t('tools.wifi-qr-code-generator.texts.label-eap-method')"
          label-position="left"
          label-width="130px"
          label-align="right"
        ...
        <div v-if="encryption === 'WPA2-EAP'" class="mb-6 flex flex-row items-center gap-2">
          <c-input-text
            ...
            label-width="130px"
            label-align="right"
            :label="t('tools.wifi-qr-code-generator.texts.label-identity')"
            rows="1"
            autosize
            :placeholder="t('tools.wifi-qr-code-generator.texts.placeholder-your-eap-identity')"
            mb-6
          />
        ...
        <c-select
          ...
          :label="t('tools.wifi-qr-code-generator.texts.label-eap-phase-2-method')"
          label-position="left"
          label-width="130px"
          label-align="right"
