...
<template>
  <div>
    <c-input-text
      ...
      :label="t('tools.slugify-string.texts.label-your-string-to-slugify')"
      autofocus
      raw-text
      mb-2
    />
    ...
    <c-input-text
      ...
      :label="t('tools.slugify-string.texts.label-separator-character')"
      raw-text
      mb-5
    />
    ...
    <c-input-text
      ...
      :label="t('tools.slugify-string.texts.label-your-slug')"
      mb-5
    />
