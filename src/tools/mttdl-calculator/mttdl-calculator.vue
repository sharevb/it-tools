...
function getMTTDL({
  ...
  switch (raidLevel) {
    ...
    case 'RAID-Z3':
      return (
        mtbf /
        (numDrives * (numDrives - 1) * (numDrives - 2) * (numDrives - 3) * λ * rebuildTime * unrecoverableReadProb)
      );
    case 'RAID 50':
...
<template>
  <NCard
    :title="t('tools.mttdl-calculator.texts.title-mttdl-failure-probability-calculator')"
  ...
  >
    <NForm :model="form" label-width="190px" label-placement="left">
      <NFormItem :label="t('tools.mttdl-calculator.texts.label-raid-level')">
        <NSelect
          v-model:value="form.raidLevel"
          :options="raidOptions"
          :placeholder="t('tools.mttdl-calculator.texts.placeholder-select-raid-level')"
        />
      </NFormItem>
      ...
      <details>
        ...
        <p>
          {{
            t(
              'tools.mttdl-calculator.texts.tag-raid-redundant-array-of-independent-disks-is-a-method-of-combining-multiple-physical-drives-into-one-logical-unit-to-improve-performance-redundancy-or-both',
            )
          }}
        </p>
          ...
          <tbody>
            <tr>
              ...
              <td>
                {{
                  t(
                    'tools.mttdl-calculator.texts.tag-striping-only-no-redundancy-fast-but-risky-if-one-drive-fails-all-data-is-lost',
                  )
                }}
              </td>
            </tr>
            <tr>
              ...
              <td>
                {{
                  t(
                    'tools.mttdl-calculator.texts.tag-mirroring-data-is-duplicated-across-drives-high-redundancy-low-capacity-efficiency',
                  )
                }}
              </td>
            </tr>
            <tr>
              ...
              <td>
                {{
                  t(
                    'tools.mttdl-calculator.texts.tag-striping-with-parity-can-tolerate-one-drive-failure-balanced-speed-and-redundancy',
                  )
                }}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                {{
                  t('tools.mttdl-calculator.texts.tag-mirrored-pairs-striped-together-high-performance-and-redundancy')
                }}
              </td>
            </tr>
            <tr>
              ...
              <td>
                {{
                  t(
                    'tools.mttdl-calculator.texts.tag-zfs-based-raid-levels-with-single-double-or-triple-parity-designed-for-data-integrity',
                  )
                }}
              </td>
            </tr>
            <tr>
              ...
              <td>
                {{
                  t(
                    'tools.mttdl-calculator.texts.tag-stripe-of-raid-5-arrays-combines-performance-of-raid-0-with-redundancy-of-raid-5',
                  )
                }}
              </td>
            </tr>
        ...
        <p>
          {{
            t(
              'tools.mttdl-calculator.texts.tag-the-average-time-in-hours-a-drive-is-expected-to-operate-before-failing-higher-mtbf-means-more-reliable-hardware',
            )
          }}
        </p>
        ...
        <p>
          {{
            t(
              'tools.mttdl-calculator.texts.tag-the-time-required-to-reconstruct-data-on-a-replacement-drive-after-a-failure-longer-rebuild-times-increase-the-risk-of-a-second-failure-during-recovery',
            )
          }}
        </p>
        ...
        <p>
          {{
            t(
              'tools.mttdl-calculator.texts.tag-a-statistical-estimate-of-how-long-a-raid-system-can-operate-before-data-loss-occurs-it-considers-drive-failures-rebuild-time-and-raid-redundancy-higher-mttdl-means-a-safer-system',
            )
          }}
        </p>
        ...
        <p>
          {{
            t(
              'tools.mttdl-calculator.texts.tag-the-probability-that-a-bit-read-from-a-disk-will-be-incorrect-due-to-hardware-limitations-even-tiny-bers-like-1-in-a-trillion-can-cause-issues-during-rebuilds-especially-with-large-drives',
            )
          }}
        </p>
        ...
        <p>
          {{
            t(
              'tools.mttdl-calculator.texts.tag-occurs-when-a-drive-fails-to-read-a-sector-during-rebuild-ber-contributes-to-ure-risk-which-can-compromise-raid-recovery',
            )
          }}
        </p>
        ...
        <p>
          {{
            t(
              'tools.mttdl-calculator.texts.tag-total-storage-per-drive-larger-drives-take-longer-to-rebuild-and-are-more-susceptible-to-ber-related-errors',
            )
          }}
        </p>
        ...
        <p>
          {{
            t(
              'tools.mttdl-calculator.texts.tag-the-chance-that-the-raid-system-will-experience-data-loss-over-a-given-time-period-e-g-5-years-calculated-using-mttdl-and-exponential-failure-models',
            )
          }}
        </p>
      </details>
