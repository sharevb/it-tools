declare module 'paseto-ts/v4' {
  ...
  export declare function sign(
    ...
    payload: Payload | string | Uint8Array,
    {
      footer,
      assertion,
      addExp, // Add an exp claim if one is not provided: https://github.com/paseto-standard/paseto-spec/blob/master/docs/02-Implementation-Guide/05-API-UX.md#default-expiration-claims
