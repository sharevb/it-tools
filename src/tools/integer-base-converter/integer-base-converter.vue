...
function getGroupSizeForBase(base: number): number {
  ...
  switch (base) {
    case 2:
      return groupSizes.value.binary;
    case 8:
      return groupSizes.value.octal;
    case 10:
      return groupSizes.value.decimal;
    case 16:
      return groupSizes.value.hex;
    case 64:
      return groupSizes.value.base64;
    default:
...
<template>
  <div>
    <c-card>
      <c-input-text
        v-model:value="input"
        :label="t('tools.integer-base-converter.texts.label-input-number')"
        :placeholder="t('tools.integer-base-converter.texts.placeholder-put-your-number-here-ex-42')"
        label-position="left"
        label-width="110px"
        mb-2
        label-align="right"
      ...
      <n-form-item
        ...
        :label="t('tools.integer-base-converter.texts.label-input-base')"
      ...
      >
        <n-input-number-i18n
          ...
          max="64"
          min="2"
          :placeholder="t('tools.integer-base-converter.texts.placeholder-put-your-input-base-here-ex-10')"
          w-full
        />
      </n-form-item>

      <n-form-item
        :label="t('tools.integer-base-converter.texts.label-space-separation')"
        label-placement="left"
        label-width="110"
        :show-feedback="false"
      ...
      <div
        v-if="useSpaceSeparation"
        style="margin-top: 10px; margin-bottom: 20px; padding-left: 20px; border-left: 2px solid var(--n-border-color)"
      >
        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(140px, 1fr)); gap: 10px">
          <n-form-item
            :label="t('tools.integer-base-converter.texts.label-binary-size')"
            label-placement="top"
            :show-feedback="false"
          >
          ...
          <n-form-item
            :label="t('tools.integer-base-converter.texts.label-octal-size')"
            label-placement="top"
            :show-feedback="false"
          >
          ...
          <n-form-item
            :label="t('tools.integer-base-converter.texts.label-decimal-size')"
            label-placement="top"
            :show-feedback="false"
          >
          ...
          <n-form-item
            :label="t('tools.integer-base-converter.texts.label-hexadecimal-size')"
            label-placement="top"
            :show-feedback="false"
          >
          ...
          <n-form-item
            :label="t('tools.integer-base-converter.texts.label-base64-size')"
            label-placement="top"
            :show-feedback="false"
          >
          ...
          <n-form-item
            :label="t('tools.integer-base-converter.texts.label-custom-size')"
            label-placement="top"
            :show-feedback="false"
          >
