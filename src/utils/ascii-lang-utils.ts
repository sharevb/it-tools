...
export const languages = [
  ...
  },
  {
    ...
    escape: escapeBackslash + escapeDoubleQuote,
  },
  {
    id: 'pwsh',
    name: 'PowerShell',
    ...
    escape: escapeBackslash + escapeSingleQuote,
  },
  {
    id: 'c',
    name: 'C',
  ...
  },
  {
    ...
    escape: (l: string) => l.replace(/[\\'"]/g, (m: string) => `\\${m}`).replace(/\t/g, '\\t'),
  },
  {
    id: 'csharp_verb',
    name: 'C# (Verbatim)',
    ...
    escape: (l: string) => l.replace(/["]/g, '""').replace(/\t/g, '\\t'),
  },
  {
    id: 'csharp_interf',
    name: 'C# (Interpolated)',
    ...
    escape: (l: string) => l.replace(/["{}]/g, (m: string) => m + m).replace(/\t/g, '\\t'),
  },
  {
    id: 'csharp_raw',
    name: 'C# (Raw)',
  ...
  return (
    ...
    s
      ...
      .map((line) => {
        return (
          langConfig.prefix +
          escapeForLanguage(line, languageId, { suffix_eol: langConfig.suffix_eol || '' }) +
          langConfig.suffix
        );
      })
      .join('\n') +
...
export function escapeForLanguage(
  s: string,
  languageId: string,
  options: {
    suffix_eol?: string;
  ...
  return (options.single_linize ? [s] : s.split('\n'))
    .map((line) => {
      return (
        langConfig.start_quote +
        escapeMultiLine(line) +
        (options.suffix_eol || '') +
        (langConfig.end_quote || langConfig.start_quote)
      );
    })
    .join('\n');
}
